package com.seaboxdata.rop.utils;
...
public class RedisUtil {
	...
	public void deleteCache(String... key) {
		try {
			...
			log.error("class:RedisUtils method:deleteCache() => Exception {}", e.getMessage());
		}
	}
	...
	public <T> T get(String key, Class<T> clazz, long expire) {
		try {
			...
			log.error("class:RedisUtils method:get() => Exception {}", e.getMessage());
			return null;
		}
	}
	...
	public <T> T getObj(String key, Class<T> clazz) {
		...
		try {
			...
			log.error("class:RedisUtils method:getObj() => Exception {}", e.getMessage());
		}
		return t;
	}
	...
	public Object hdel(String key) {
		Object obj;
		try {
			obj = redisTemplate.delete(key);

		} catch (Exception e) {
			log.error("删除redis hash 出错,{}" + e);
			throw new ServiceException("500", "删除 redis hash 出错");
		}
		return obj;
	}
	...
	public Object hget(String key, String item) {
		...
		try {
			...
			log.error("获取redis hash 出错,{}" + e);
			throw new ServiceException("500", "获取redis hash 出错");
		}
		return obj;
	}
	...
	public <T> T hget(String key, String item, Class<T> clazz) {
		...
		try {
			...
			log.error("class:RedisUtils method:getObj() => Exception {}", e.getMessage());
			throw new ServiceException("500", "获取redis出错");
		}
		return t;
	}
